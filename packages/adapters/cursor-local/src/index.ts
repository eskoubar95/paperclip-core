...
Option B (future): materialize a run-scoped .cursor/mcp.json under cwd from company+agent MCP policy so CLI only sees allowed servers (spike global vs project merge first).
`;
