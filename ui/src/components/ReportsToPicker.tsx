          ...
          {unknownManager ? (
            ...
            <>
              <AgentIcon
                ...
                className="h-3 w-3 shrink-0 rounded-[3px] object-cover text-muted-foreground"
              />
              <span
                className={cn(
                  "min-w-0 truncate",
      ...
      <PopoverContent className="w-48 p-1" align="start">
        ...
        {terminatedManager && (
          <div className="flex min-w-0 items-center gap-2 overflow-hidden px-2 py-1.5 text-xs text-muted-foreground border-b border-border mb-0.5">
            <AgentIcon icon={current.icon} avatarUrl={current.avatarUrl} className="shrink-0 h-3 w-3 rounded-[3px] object-cover" />
            <span className="min-w-0 truncate">
